...
| `DISCORD_BAO_BAN_CHANNEL_ID` | Channel `#🤒│báo-bận`, linked from the formation announcement. Same rule: set it before merging, a missing value kills the API at boot |
