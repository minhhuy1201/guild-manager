...
/**
 * The Discord brand mark, inline because lucide-react ships no brand icons.
 * `currentColor` fill, so it takes the colour of whatever button it sits in.
 * @param className - Extra classes, merged after the defaults
 * @returns The Discord logo
 */
