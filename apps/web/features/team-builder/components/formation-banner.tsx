...
export function FormationBanner({
  ...
  return (
    <h2 className="col-span-full flex min-h-24 flex-wrap items-center justify-center gap-x-2 gap-y-1 rounded-xl border-2 border-violet-600 bg-violet-200 px-4 py-3 text-center text-xl font-bold tracking-wide text-violet-950 sm:text-2xl">
