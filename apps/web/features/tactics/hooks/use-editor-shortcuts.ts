...
/**
 * The editor's keyboard: tools on 1-6, stroke width on [ and ], Delete for the whole selection,
 ...
 * @param onDeleteSelected - Called by Delete or Backspace, to remove every selected element
 */
